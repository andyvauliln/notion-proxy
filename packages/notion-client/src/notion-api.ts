...
export class NotionAPI {
  ...
  public async getCollectionData(
    ...
    if (groupBy) {
      ...
      console.log(collectionView.format,'collectionView.format' );
      let filters = []
      //TODO: started working on the filters. This doens't seem to quite work yet.
      if(collectionView.format && collectionView.format.property_filters){
  ...
  public async fetch<T>({
    ...
    // console.log(url, body,headers, gotOptions, 'data' );
    // console.log('___________________________','data' );
    return got
      .post(url, {
        ...gotOptions,
